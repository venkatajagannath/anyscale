...
from anyscale_client.models.session_response import SessionResponse  # noqa: E501
...
class TestSessionResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = anyscale_client.models.session_response.SessionResponse()  # noqa: E501
        if include_optional :
            return SessionResponse(
                result = anyscale_client.models.session.Session(
                    name = '0', 
                    project_id = '0', 
                    cloud_id = '0', 
                    cluster_config = '0', 
