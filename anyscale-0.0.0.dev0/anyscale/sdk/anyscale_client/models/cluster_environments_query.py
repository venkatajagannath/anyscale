...
class ClusterEnvironmentsQuery(object):
    ...
    def __init__(self, project_id=None, creator_id=None, name=None, paging=None, include_archived=False, include_anonymous=False, local_vars_configuration=None):  # noqa: E501
