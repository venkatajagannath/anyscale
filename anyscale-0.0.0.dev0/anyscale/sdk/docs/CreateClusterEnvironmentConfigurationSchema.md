...
------------ | ------------- | ------------- | -------------
**base_image** | [**SUPPORTEDBASEIMAGESENUM**](SUPPORTEDBASEIMAGESENUM.md) | The base image to use to create a new Cluster Environment. It needs to be one of the images that we currently support (SupportedBaseImages). | 
