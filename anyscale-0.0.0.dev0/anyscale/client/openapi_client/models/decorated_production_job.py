...
class DecoratedProductionJob(object):
    ...
    openapi_types = {
        ...
        'state': 'DecoratedProductionJobStateTransition',
        'project_id': 'str',
        'last_job_run_id': 'str',
        'schedule_id': 'str',
        'job_queue_id': 'str',
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DecoratedProductionJob):
            return False
